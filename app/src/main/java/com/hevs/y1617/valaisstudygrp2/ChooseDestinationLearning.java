...
public class ChooseDestinationLearning extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_destination_learning_menu);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout_chooseDestinationLearning);
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close);
        drawer.addDrawerListener(toggle);
        toggle.syncState();

        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view_chooseDestinationLearning);
    ...
    private void checkLoggedIn(){
        if(CurrentUser.getId() != -1 && !CurrentUser.isChooseDest()){
            ...
            intent.putExtra("ChosenLearningDestination", GetRestDataDB.getDestinationWithIDFromDB(this, CurrentUser.getDestinationId()));
    ...
    private void setListAdapter(){
        ListView lv = (ListView) findViewById(R.id.DestinationLVLearning);
