...
public class CustomerLearning extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_learning);
    ...
    {
        this.myWebView = (WebView) findViewById(R.id.activity_CustomerLearning_webview);

        // Enable Javascript
        this.myWebView.getSettings().setJavaScriptEnabled(true);

        String html = "<iframe width=\"100%\" height=\"100%\" src=\"https://extranet.tourobs.ch/ApiTourobs/LearningCustomer?id_dest="+idDestination+"&lang="+lang+"\" />";
