...
public class GastronomyLearning extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gastronomy_learning);
    ...
    {
        this.myWebView = (WebView) findViewById(R.id.activity_GastronomyLearning_webview);

        // Enable Javascript
        this.myWebView.getSettings().setJavaScriptEnabled(true);

        String html = "<iframe width=\"100%\" height=\"100%\" src=\"https://extranet.tourobs.ch/ApiTourobs/LearningGastronomy?id_dest="+idDestination+"&lang="+lang+"\" />";
